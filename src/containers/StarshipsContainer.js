...
//Container that loads an item which category is Starships
...
//update the info fetched from getData()
  ...
  render() {
    if (this.state.url === '') {
      ...
      return(
        <div>
          <h1>This is a Starship component</h1>
          <div>
            <h1> 
              <span> Name : </span> 
            ...
            <h1> 
              <span> MGLT : </span> 
              <span>{this.state.MGLT} </span>
            </h1>
            <h1> 
              <span> Hyperdrive Rating : </span> 
              <span>{this.state.hyperdrive_rating} </span>
            </h1>
            <h1> 
            ...
            <h1> 
              ...
              <span>{this.state.starship_class} </span>
            </h1>
            <h1> 
